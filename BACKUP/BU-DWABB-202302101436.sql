...
-- Started on 2023-02-10 14:36:41
...
52	2023-02-07 09:25:45.925011+01	12	BASANE	1	[{"added": {}}]	7	2
53	2023-02-07 09:27:09.344563+01	3	3	1	[{"added": {}}]	8	2
\.
...
12	BASANE	CUIR FINI	65	813	CF01
\.
...
3	ZERHOUNI	CENTRE VILLE, ORAN	041	ZERHOUNI@GMAIL.COM	#	#	#	3	CL003
\.
...
2078	ACHAT 5L MAZOT	150	2023-02-07	1213	FR230001213	1
2079	ACHAT QUINCAILLERIE GENERAL	1690	2023-02-08	1214	FR230001214	1
...
2080	ACHAT 10 L MAZOT	300	2023-02-08	1215	FR230001215	1
...
SELECT pg_catalog.setval('public."main_article_AR_ID_seq"', 12, true);
...
SELECT pg_catalog.setval('public."main_client_CL_ID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."main_frais_FR_ID_seq"', 2080, true);
...
SELECT pg_catalog.setval('public."main_venteentete_VNTENT_ID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."main_venteligne_VNTLIG_ID_seq"', 2, true);
...
-- Completed on 2023-02-10 14:36:42
